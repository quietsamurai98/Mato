...
def tick args
  ...
  FFI::MatoCore::create_terrain(args.inputs.mouse.x.to_i, args.inputs.mouse.y.to_i, 3, args.state.brush_material) if args.inputs.mouse.button_left
...
def brushtype material = ""
  ...
  if material == "XHST"
    ...
    "USAGE: brushtype [MATERIAL]\n     Valid materials: XHST, DIRT, SAND, NONE"
  end
end
